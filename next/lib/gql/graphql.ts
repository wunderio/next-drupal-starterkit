...
type FragmentMediaUnion_MediaDocument_Fragment = { __typename?: 'MediaDocument', id: string, name: string, mediaDocument: { __typename?: 'File', name?: string | null, url: string, size: number, mime?: string | null, description?: string | null } };

type FragmentMediaUnion_MediaImage_Fragment = { __typename?: 'MediaImage', id: string, mediaImage: { __typename?: 'Image', url: string, width: number, height: number, alt?: string | null, title?: string | null, size: number, mime?: string | null } };
...
type FragmentMediaUnion_MediaVideo_Fragment = { __typename?: 'MediaVideo' };
...
export type FragmentMediaDocumentFragment = { __typename?: 'MediaDocument', id: string, name: string, mediaDocument: { __typename?: 'File', name?: string | null, url: string, size: number, mime?: string | null, description?: string | null } };

export type FragmentMediaImageFragment = { __typename?: 'MediaImage', id: string, mediaImage: { __typename?: 'Image', url: string, width: number, height: number, alt?: string | null, title?: string | null, size: number, mime?: string | null } };

export type FragmentMediaRemoteVideoFragment = { __typename?: 'MediaRemoteVideo', id: string, name: string, mediaOembedVideo: string };

export type FragmentParagraphFormattedTextFragment = { __typename: 'ParagraphFormattedText', id: string, formattedTextText: { __typename?: 'Text', value?: string | null, processed?: any | null, format?: string | null } };
...
export type FragmentParagraphImageFragment = { __typename: 'ParagraphImage', id: string, image: { __typename?: 'MediaAudio', id: string, name: string, mediaAudioFile: { __typename?: 'File', name?: string | null, url: string, size: number, mime?: string | null, description?: string | null } } | { __typename?: 'MediaDocument', id: string, name: string, mediaDocument: { __typename?: 'File', name?: string | null, url: string, size: number, mime?: string | null, description?: string | null } } | { __typename?: 'MediaImage', id: string, mediaImage: { __typename?: 'Image', url: string, width: number, height: number, alt?: string | null, title?: string | null, size: number, mime?: string | null } } | { __typename?: 'MediaRemoteVideo', id: string, name: string, mediaOembedVideo: string } | { __typename?: 'MediaVideo' } };
