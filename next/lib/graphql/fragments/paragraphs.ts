...
import { FRAGMENT_LINK, FRAGMENT_TEXT } from "./fields";
import { FRAGMENT_MEDIA_UNION } from "./media";
...
export const FRAGMENT_PARAGRAPH_FILE_ATTACHMENTS = graphql(
  ...
  `,
  [FRAGMENT_TEXT, FRAGMENT_MEDIA_UNION],
);
...
export const FRAGMENT_PARAGRAPH_HERO = graphql(
  ...
  `,
  [FRAGMENT_TEXT, FRAGMENT_LINK, FRAGMENT_MEDIA_UNION],
);
...
export const FRAGMENT_PARAGRAPH_ACCORDION = graphql(
  ...
  `,
  [FRAGMENT_LINK, FRAGMENT_TEXT, FRAGMENT_PARAGRAPH_ACCORDION_ITEM],
);
...
export const FRAGMENT_PARAGRAPH_UNION = graphql(
  ...
  [
    ...
    FRAGMENT_PARAGRAPH_ACCORDION_ITEM,
