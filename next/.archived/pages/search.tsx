...
import { HeadingPage } from "@/archived-components/heading--page";
import { Meta } from "@/archived-components/meta";
import { SearchBoxInput } from "@/archived-components/search/search-box-input";
import { MultiCheckboxFacet } from "@/archived-components/search/search-multicheckbox-facet";
import { Pagination } from "@/archived-components/search/search-pagination";
import { PagingInfoView } from "@/archived-components/search/search-paging-info";
import { SearchResult } from "@/archived-components/search/search-result";
