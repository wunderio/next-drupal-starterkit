  ...
  return (
    <fieldset className={clsx(className, "mb-4")}>
      ...
      {showMore && (
        <button
          type="button"
          className="rounded border border-wunderpurple-500 bg-transparent py-2 px-4 text-xs font-bold text-wunderpurple-700 hover:border-transparent hover:bg-wunderpurple-500 hover:text-white"
          onClick={onMoreClick}
