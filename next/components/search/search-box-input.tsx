...
export const SearchBoxInput: React.ComponentType<InputViewProps> = ({
  ...
  return (
    <div className="relative w-full">
      ...
      <button
        {...getButtonProps()}
        className="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2"
      >
