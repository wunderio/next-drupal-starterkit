  ...
  return (
    <div className="relative w-full max-w-xl">
      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
        <SearchIcon
          aria-hidden
          className="h-5 w-5 text-scapaflow dark:text-stone"
        />
      </div>
      <input
        {...getInputProps()}
        className="block w-full rounded-lg border border-primary-100 bg-white p-4 pl-10 text-sm text-steelgray focus:border-primary-500 focus:ring-primary-500 dark:border-scapaflow dark:bg-steelgray dark:text-white dark:placeholder-graysuit dark:focus:border-primary-500 dark:focus:ring-primary-500"
